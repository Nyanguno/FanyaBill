...
function renderInvoicePreview() {
    ...
    // **FIX**: Update business information from the global businessInfo object
    ...
    // **FIX**: Update customer information, including phone and email
    const customerName = document.getElementById("customerName").value || "Walk-in Customer";
